...
public partial class Cerfa13750LocatairePage : ContentPage
{
    private readonly Cerfa13750Data _data;
    private ProprietaireScanPage?   _pendingScan;

    public Cerfa13750LocatairePage(Cerfa13750Data data)
    {
        InitializeComponent();
        _data = data;
    }
    ...
    private async void OnRecapClicked(object sender, EventArgs e)
    {
